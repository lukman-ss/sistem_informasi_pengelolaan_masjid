                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <td class="min-w-400px"><?= $value['isi_berita'] ?></td>
                                <td><img width="70px" height="70px"
                                        src="<?= base_url('/uploads/berkas/') . $value['image'] ?>">
                                </td>
                                <td>
                                    <a data-bs-toggle="modal" data-bs-target="#edit_berita_<?= $value['id_berita'] ?>" class="btn btn-warning btn-sm">Ubah</a>
                                    <a class="btn btn-danger btn-sm" href="<?= base_url('berita/delete/') . $value['id_berita'] ?>">Hapus</a>
                                </td>
                            </tr>
                    ...
                    <div class="flex-row-fluid py-lg-5 px-lg-15">
                        <form action="<?= base_url('berita/store') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="isi_berita" required
...
<!--begin::Modal - Create App-->
<div class="modal fade" id="edit_berita_<?= $value['id_berita'] ?>" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <!--begin::Modal content-->
        <div class="modal-content">
                ...
                <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                    ...
                    <div class="flex-row-fluid py-lg-5 px-lg-15">
                        <form action="<?= base_url('berita/update') ?>" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id_berita" value="<?= $value['id_berita'] ?>">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Judul Berita</label>
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Isi
                                    Berita</label>
                                <textarea class="form-control" name="isi_berita" required
                                    id="exampleFormControlTextarea1" rows="7"><?= $value['isi_berita'] ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Gambar</label>
                                <input class="form-control" type="file" name="gambar" value="<?= base_url('/uploads/berkas/') . $value['image'] ?>"
                                    id="formFile">
                            </div>
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary btn-md">Simpan</button>
